...
contextBridge.exposeInMainWorld('flowApi', {
  ...
  getChatState: () => ipcRenderer.invoke('chat:getState'),
  listChatTargets: () => ipcRenderer.invoke('chat:listTargets'),
  listChatChannels: () => ipcRenderer.invoke('chat:listChannels'),
  updateChatSettings: (payload) => ipcRenderer.invoke('chat:updateSettings', payload || {}),
